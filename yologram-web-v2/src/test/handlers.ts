...
export const handlers = [
  ...
  http.get('http://localhost:5002/api/v2/pms/posts/me', ({ request }) => {
    ...
    const all = [
      { id: 3001, section: 'TECH', author: { uid: 1, nickname: '테스터' }, content: '내 기술 글 1', categoryIds: [1], metrics: { commentCount: 0, likeCount: 2, viewCount: 0, likedByMe: false }, createdAt: '2026-06-18T09:00:00' },
      { id: 3002, section: 'INVEST', author: { uid: 1, nickname: '테스터' }, content: '내 투자 글 1', categoryIds: [9], metrics: { commentCount: 2, likeCount: 5, viewCount: 0, likedByMe: false }, createdAt: '2026-06-17T09:00:00' },
      { id: 3003, section: 'POLITICS', author: { uid: 1, nickname: '테스터' }, content: '내 정치 글 1', categoryIds: [16], metrics: { commentCount: 0, likeCount: 1, viewCount: 0, likedByMe: false }, createdAt: '2026-06-16T09:00:00' },
    ]
