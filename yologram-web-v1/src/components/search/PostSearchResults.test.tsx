...
const SEARCH_URL = 'http://localhost:5001/api/v1/search/tech/posts'
const CATEGORIES_URL = 'http://localhost:5001/api/v1/cms/tech/categories'
...
describe('PostSearchResults (결과 렌더)', () => {
  ...
  it('항목을 클릭하면 상세로 이동한다', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/tech/community/1200')
  })
})
