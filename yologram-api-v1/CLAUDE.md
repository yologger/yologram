...
- src/main/kotlin/.../domain/{pms,cms,comment,news}/tech: 도메인 우선 구조 — pms/tech(TechPostService·QueryDSL), cms/tech(TechCategoryService — tech_category 공용 마스터), comment/tech(TechPostCommentService), news/tech(TechNewsService — 공개 조회: 복합 커서·categoryId 필터·라벨 조인)
