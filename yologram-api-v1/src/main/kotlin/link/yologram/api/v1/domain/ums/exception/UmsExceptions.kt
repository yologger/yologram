...
class AdminUserOwnerUndeletableException : UmsException("OWNER 계정은 삭제할 수 없습니다.", "ADMIN_USER_OWNER_UNDELETABLE")
class AdminUserOwnerImmutableException : UmsException("OWNER 계정은 변경할 수 없습니다.", "ADMIN_USER_OWNER_IMMUTABLE")
class AdminRoleForbiddenException : UmsException("OWNER만 가능한 작업입니다.", "ADMIN_ROLE_FORBIDDEN")
class AdminUserInactiveException : UmsException("비활성화된 계정입니다.", "ADMIN_USER_INACTIVE")
