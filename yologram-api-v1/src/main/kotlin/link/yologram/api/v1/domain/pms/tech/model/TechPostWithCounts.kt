...
/**
 * 게시글 + 카운트(댓글 수·좋아요 수·조회 수) 조회 프로젝션 (QueryDSL Projections.constructor 용, 응답 DTO 아님).
 * 각 카운트는 tech_post_comment_count / tech_post_like_count / tech_post_view_count leftJoin + coalesce(0) 결과 —
