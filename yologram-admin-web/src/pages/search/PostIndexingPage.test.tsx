...
import PostIndexingPage from './PostIndexingPage'
...
function renderPage() {
  return renderWithProviders(<PostIndexingPage section="tech" sectionLabel="기술" />)
}
...
describe('PostIndexingPage (전체 인덱싱)', () => {
...
describe('PostIndexingPage (범위 인덱싱)', () => {
...
describe('PostIndexingPage (단건 인덱싱)', () => {
