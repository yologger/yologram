...
React 기반 어드민 웹. 회원/카테고리/게시글/RSS 피드 관리 기능 제공 예정 (현재 부트스트랩 — 전 메뉴 준비 중).
...
- src/App.tsx: 앱 진입점
- src/components/layout/AdminLayout.tsx: 어드민 공통 레이아웃 (사이드바 + 콘텐츠)
...
- 어드민은 데스크탑 전용 — 반응형 분기(useIsMobile 등) 하지 않음
